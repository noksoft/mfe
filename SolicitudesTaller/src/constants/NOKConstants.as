package constants
{
	public class NOKConstants
	{
		...
		public static var SERVICE_DESTINATION_SOLICITUDES:String = "solicitudBussiness";
		...
		public static var SERVICE_DESTINATION_FALLA_EQUIPO:String = "fallaEquipoBusiness";
	}
}