package view.components
{
	...
	public class ViewEquipoMecanicoBase extends VBox
	{
		/***********	VARIABLE'S	*****************/
		[Bindable]public var titlePanel:String = "Equipo Mecánico";
		...
		public var viewEquipo:ViewEquipoMecanico = ViewEquipoMecanico(this);
		...
		public function preInit():void{
			...
			subCategoriaTemp.idCategoria = "6";
		...
		public function saveUpdate():void
		{
			...
			//KW
			itemSelected.kw = viewEquipo.nstpkw.value.toString();
			//Voltaje
			itemSelected.voltaje = viewEquipo.nstpVoltaje.value.toString();
			//Amperes
			itemSelected.amperes = viewEquipo.nstpAmperes.value.toString();
			//Capacidad Presión
			itemSelected.capacidadpresion = viewEquipo.nstpCapacidadPresion.value.toString();
		...
		public function cleanFormulario():void
		{
			...
			//KW
			viewEquipo.nstpkw.value = 0;
			//Voltaje
			viewEquipo.nstpVoltaje.value = 0;
